...
const searchOdf = async (req, res) => {
    ...
    if (!barcode.data.QTDE_LIB) {
        ...
        return res.json({ status: (0, message_1.message)(1), message: (0, message_1.message)(1), data: (0, message_1.message)(1), code: resultVerifyCodeNote.code || (0, message_1.message)(33) });
    }
};
