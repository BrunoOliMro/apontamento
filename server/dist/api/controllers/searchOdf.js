    ...
    try {
        ...
        if (x === 'Update sucess') {
            if (lookForChildComponents.quantidade) {
                console.log('linha 106 /searchOdf/ ', (0, encryptOdf_1.encrypted)(String(lookForChildComponents.quantidade)));
                res.cookie('quantidade', (0, encryptOdf_1.encrypted)(String(lookForChildComponents.quantidade)));
            }
