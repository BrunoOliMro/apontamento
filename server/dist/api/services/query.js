...
const selectQuery = async (chosenOption, values) => {
    ...
    const codes = {
        ...
        20: `SELECT [CODIGO], [IMAGEM] FROM VIEW_APTO_FERRAMENTAL WHERE 1 = 1 AND IMAGEM IS NOT NULL AND CODIGO = '${values.CODIGO_PECA}' AND MAQUIN = '${values.CODIGO_MAQUINA}' AND NUMOPE = ${values.NUMERO_OPERACAO}`,
    ...
    try {
        ...
        return { message: (0, message_1.message)(33), data: (0, message_1.message)(33) };
    }
};
